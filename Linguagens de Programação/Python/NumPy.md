...
A indexação por array booleano ocorre quando *obj* é um objeto array do tipo booleano, como o que pode ser retornado de [operadores de comparação](#Funções%20lógicas).
